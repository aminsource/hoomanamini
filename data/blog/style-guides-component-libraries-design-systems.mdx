...
inside Markdown files. The blog you're reading right now [uses this](https://github.com/leerob/manakit.ir).
...
Feel free to [reach out](mailto:me@manakit.ir) if you wanna chat about building design systems.
